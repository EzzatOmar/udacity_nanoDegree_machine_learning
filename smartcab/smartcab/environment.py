...
class Environment(object):
    ...
    def reset(self, testing=False, t=0):
        ...
        for agent in self.agent_states.iterkeys():
            ...
            agent.reset(destination=(destination if agent is self.primary_agent else None), testing=testing, t=t)
            if agent is self.primary_agent:
...
class Agent(object):
    ...
    def reset(self, destination=None, testing=False, t=0):
        pass
